  ...
  return (
    <div>
      ...
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
        <div>
          <h4 className="fw-bold mb-1" style={{ color: '#111827' }}>{t('appointmentHistory')}</h4>
          ...
          <div className="d-flex flex-column gap-3">
            ...
            <div style={{ overflowX: 'auto', WebkitOverflowScrolling: 'touch', marginLeft: -4, marginRight: -4, paddingLeft: 4, paddingRight: 4 }}>
              <div className="d-flex gap-2" style={{ minWidth: 'max-content' }}>
                {[
                  { key: 'all', labelKey: 'all', color: '#1d4ed8' },
                  { key: 'pending', labelKey: 'pending', color: '#92400e' },
                  { key: 'approved', labelKey: 'approved', color: '#1d4ed8' },
                  { key: 'completed', labelKey: 'completed', color: '#16a34a' },
                  { key: 'cancelled', labelKey: 'cancelled', color: '#dc2626' },
                  { key: 'rejected', labelKey: 'rejected', color: '#dc2626' },
                ].map((f) => (
                  <button
                    key={f.key}
                    ...
                    style={{
                      ...
                      borderRadius: 20,
                      border: 'none',
                      backgroundColor: filterStatus === f.key ? f.color : '#f3f4f6',
        ...
        <Card.Body className="p-4">
          ...
          {loading ? (
            ...
            <div className="text-center py-5" style={{ color: '#9ca3af' }}>
              ...
              <div style={{ fontSize: 14 }}>{t('noAppointments')}</div>
            </div>
          ) : (
