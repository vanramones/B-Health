...
import { HeartPulse, Plus, Lock, Eye, EyeOff, ArrowRight, Shield, Clock, Users, User, Check } from 'lucide-react';
...
const UserLogin = () => {
  ...
  useEffect(() => {
    if (location.state?.registrationSuccess) {
      setToast({ type: 'success', message: `Welcome, ${location.state.userName}! Your account has been created successfully.` });
  ...
  return (
    <>
      ...
      {/* Toast Notification */}
      {toast && (
        <div className="ul-toast">
          <div className="ul-toast-icon">
