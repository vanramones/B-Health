      ...
      {open && ReactDOM.createPortal(
        <>
          ...
          <div ref={dropRef} style={{
            position: 'fixed',
            top: (() => { const r = bellRef.current?.getBoundingClientRect(); return r ? r.bottom + 8 : 60; })(),
            right: (() => { const r = bellRef.current?.getBoundingClientRect(); return r ? window.innerWidth - r.right : 12; })(),
            ...
            <div style={{ padding: '16px 16px 8px' }}>
              ...
              {unreadCount > 0 && (
                <div style={{ marginTop: 8, display: 'flex', gap: 8 }}>
                  <span style={{
                    fontSize: 13, fontWeight: 700, color: '#050505',
                    padding: '4px 12px', borderRadius: 20,
                    backgroundColor: '#e7f3ff', cursor: 'pointer',
                  }}>All</span>
                  <span style={{
            ...
            <div style={{ overflowY: 'auto', flex: 1, paddingBottom: 8 }}>
              {loading ? (
                ...
                <div style={{ padding: '40px 16px', textAlign: 'center' }}>
                  ...
                  <div style={{ fontSize: 15, fontWeight: 700, color: '#050505' }}>No notifications</div>
                ...
                <>
                  {unreadCount > 0 && (
                    <div style={{ padding: '8px 16px 4px' }}>
                      <span style={{ fontSize: 15, fontWeight: 700, color: '#050505' }}>New</span>
                    </div>
                  )}
...
const bottomNavItems = [
  { path: '/user',                  label: 'Home',         icon: homeOutline,         activeIcon: home,         color: '#1d4ed8', activeBg: '#dbeafe' },
  { path: '/user/appointments',     label: 'Appointments', icon: calendarOutline,     activeIcon: calendar,     color: '#7c3aed', activeBg: '#ede9fe' },
  { path: '/user/health-records',   label: 'Records',      icon: documentTextOutline, activeIcon: documentText, color: '#0891b2', activeBg: '#cffafe' },
  { path: '/user/health-services',  label: 'Services',     icon: medkitOutline,       activeIcon: medkit,       color: '#059669', activeBg: '#d1fae5' },
  { path: '/user/profile',          label: 'Profile',      icon: personOutline,       activeIcon: person,       color: '#e11d48', activeBg: '#ffe4e6' },
];
            ...
            <div style={{ padding: '16px 16px 12px' }}>
              <div className="d-flex align-items-center gap-3">
                ...
                <div>
                  ...
                  <div style={{ fontSize: 11, color: '#60a5fa', fontWeight: 500, letterSpacing: '0.04em' }}>User Portal</div>
                </div>
              </div>
            </div>
          </IonToolbar>
            ...
            >
              <div className="d-flex align-items-center gap-3">
                ...
                <div style={{ minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 11, color: '#60a5fa', fontWeight: 500, marginTop: 1 }}>Purok {currentUser?.purok || '—'}</div>
                </div>
              </div>
            </div>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <span
                    ...
                    style={{ color: item.color, opacity: isActive ? 1 : 0.5, transition: 'opacity 0.2s' }}
                  >
                    {item.label}
                  </span>
                </button>
